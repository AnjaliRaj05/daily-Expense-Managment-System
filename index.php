...
<body>
  ...
  <div class="d-flex" id="wrapper" style="background-image: linear-gradient(-225deg, #5D9FFF 0%, #B8DCFF 48%, #6BBBFF 100%);">

    <!-- Sidebar -->
    <div class="border-right" id="sidebar-wrapper" style="background-image: linear-gradient(to right, #434343 0%, black 100%);">
      <div class="user">
    ...
    <!-- Page Content -->
    <div id="page-content-wrapper" style="background-image: linear-gradient(-225deg, #5D9FFF 0%, #B8DCFF 48%, #6BBBFF 100%);">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col text-center">
                    <a href="manage_expense.php"><img src="icon/expense.jpeg" width="57px" />
                      <p>Manage Expenses</p>
                    </a>
                  </div>
                  <div class="col text-center">
                    <a href="profile.php"><img src="icon/pppp.jpeg" width="57px" />
                      <p>User Profile</p>
                    </a>
                  </div>
                </div>
